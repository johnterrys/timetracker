...
//         private static readonly MySqlConnectionStringBuilder ConnString = new MySqlConnectionString.Builder("" +
...
//                         while (reader.Read()) password = reader.GetString("password");
//                     }
//
...
//                     //SQL and Parameters
//                     cmd.CommandText =
//                         "UPDATE users SET username = @username, firstName = @firstName, lastName = @lastName WHERE userID = @userID";
//                     cmd.Parameters.AddWithValue("@username", user.username);
//                     cmd.Parameters.AddWithValue("@firstName", user.firstName);
//                     cmd.Parameters.AddWithValue("@lastName", user.lastName);
//                     cmd.Parameters.AddWithValue("@userID", user.userID);
...
//                     //SQL and Parameters
//                     cmd.CommandText =
//                         "UPDATE users SET username = @username, firstName = @firstName, lastName = @lastName, type = @type, isActive = @isActive WHERE userID = @userID";
//                     cmd.Parameters.AddWithValue("@username", user.username);
//                     cmd.Parameters.AddWithValue("@firstName", user.firstName);
//                     cmd.Parameters.AddWithValue("@lastName", user.lastName);
...
//                     //SQL and Parameters
//                     cmd.CommandText =
//                         "INSERT INTO timeCards (timeIn, timeOut, isEdited, userID, groupID, description)" +
...
//                     //SQL and Parameters
//                     cmd.CommandText =
//                         "DELETE FROM timeCards WHERE timeIn = @timeIn AND timeOut = @timeOut AND userID  = @userID AND groupID = @groupID AND description = @description;";
//
//                     if (timeCard.timeIn == null || timeCard.timeIn == "") cmd.Parameters.AddWithValue("@timeIn", null);
//                     else cmd.Parameters.AddWithValue("@timeIn", Convert.ToDateTime(timeCard.timeIn));
//                     if (timeCard.timeOut == null || timeCard.timeOut == "")
...
//                     //SQL and Parameters
//                     cmd.CommandText =
//                         "SELECT c.courseID FROM courses c LEFT JOIN projects p ON (c.courseID = p.courseID) " +
...
//                     {
//                         //Runs once per record retrieved
//                         while (reader.Read()) courseID = reader.GetInt32("courseID");
//                     }
//                 }
//             }
//
...
//                     {
//                         //Runs once per record retrieved
//                         while (reader.Read()) instructorID = reader.GetInt32("instructorID");
//                     }
//                 }
//             }
//
...
//                     {
//                         //Runs once per record retrieved
//                         while (reader.Read()) instructorID = reader.GetInt32("userID");
//                     }
//                 }
//             }
//
...
//                     //SQL and Parameters
//                     cmd.CommandText =
//                         "INSERT INTO evalTemplateQuestions (evalTemplateID, evalTemplateQuestionCategoryID, questionType, questionText, number) " +
...
//                     //SQL and Parameters
//                     cmd.CommandText =
//                         " SELECT * FROM uGroups WHERE userID = @userID AND groupID = @groupID AND isActive = 1";
//                     cmd.Parameters.AddWithValue("@userID", userID);
//                     cmd.Parameters.AddWithValue("@groupID", groupID);
//
//                     using (var reader = cmd.ExecuteReader())
...
//                 {
//                     cmd.CommandText =
//                         "INSERT INTO uCourses (userID, courseID, isActive) VALUES (@userID, @courseID, 0)";
//                     cmd.Parameters.AddWithValue("@userID", userID);
//                     cmd.Parameters.AddWithValue("@courseID", courseID);
//                     if (cmd.ExecuteNonQuery() > 0) return true;
//
...
//                     {
//                         cmd.CommandText =
//                             "UPDATE uCourses SET isActive = 0 WHERE courseID = @courseID AND userID = @userID";
//                         cmd.Parameters.AddWithValue("@userID", userID);
//                         cmd.Parameters.AddWithValue("@courseID", courseID);
//                         if (cmd.ExecuteNonQuery() > 0) return true;
//                     }
...
//                     cmd.Parameters.AddWithValue("@evalTemplateQuestionCategoryID",
//                         category.evalTemplateQuestionCategoryID);
//
//                     if (cmd.ExecuteNonQuery() > 0) return true;
//                     return false;
//                 }
...
//                     cmd.Parameters.AddWithValue("@evalTemplateQuestionCategoryID",
//                         question.evalTemplateQuestionCategoryID);
...
//                 {
//                     cmd.CommandText =
//                         "DELETE FROM evalTemplateQuestions WHERE evalTemplateQuestionID = @evalTemplateQuestionID";
//                     cmd.Parameters.AddWithValue("@evalTemplateQuestionID", evalTemplateQuestionID);
//
//                     if (cmd.ExecuteNonQuery() > 0) return true;
//                     return false;
...
//                     {
//                         //Runs once per record retrieved
//                         while (reader.Read()) edited = reader.GetString("createdOn");
//                     }
//
...
//                     {
//                         cmd.CommandText =
//                             "UPDATE timeCards SET timeIn = @timeIn, timeOut = @timeOut, isEdited = 1, description = @description WHERE timeID = @timeID";
...
//                     {
//                         cmd.CommandText =
//                             "UPDATE timeCards SET timeIn = @timeIn, timeOut = @timeOut, description = @description WHERE timeID = @timeID";
//                         if (timecard.timeIn == "" || timecard.timeIn == "")
//                             cmd.Parameters.AddWithValue("@timeIn", null);
//                         else cmd.Parameters.AddWithValue("@timeIn", Convert.ToDateTime(timecard.timeIn));
//
//                         if (timecard.timeOut == "" || timecard.timeOut == "")
//                             cmd.Parameters.AddWithValue("@timeOut", null);
//                         else cmd.Parameters.AddWithValue("@timeOut", Convert.ToDateTime(timecard.timeOut));
//
//                         if (timecard.description == null) cmd.Parameters.AddWithValue("@description", "");
